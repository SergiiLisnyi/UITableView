...
class ArrayData : DataEntityProtocol {
    ...
    private let dataStack = DataStructureEntity(name: "Stack", wikiURL: "https://en.wikipedia.org/wiki/Stack_(abstract_data_type)", descr: """
    ...
    """)
    private let dataQueue = DataStructureEntity(name: "Queue", wikiURL: "https://en.wikipedia.org/wiki/Queue_(abstract_data_type)", descr: """
    ...
    """)
    private let dataSet = DataStructureEntity(name: "Set", wikiURL: "https://en.wikipedia.org/wiki/Set_(abstract_data_type)", descr: """
    ...
    """)
    private let dataDequeu = DataStructureEntity(name: "Dequeue", wikiURL: "https://en.wikipedia.org/wiki/Double-ended_queue", descr: """
    ...
    """)
    private let dataPriorityQueue = DataStructureEntity(name: "Priority Queue", wikiURL: "https://en.wikipedia.org/wiki/Priority_queue", descr: """
    ...
    """)
    private let dataList = DataStructureEntity(name: "List(Array)", wikiURL: "https://en.wikipedia.org/wiki/Dynamic_array", descr: """
    ...
    """)
    private let dataMultiSet = DataStructureEntity(name: "MultiSet", wikiURL: "https://en.wikipedia.org/wiki/Multiset", descr: """
    ...
    """)
    private let dataDictionary = DataStructureEntity(name: "Dictionary", wikiURL: "https://en.wikipedia.org/wiki/Associative_array", descr: """
