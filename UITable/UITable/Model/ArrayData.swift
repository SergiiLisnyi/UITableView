...
class ArrayData : DataEntityProtocol {
    ...
    private let dataStack = DataStructureEntity(name: DataType.Stack.rawValue, type: DataType.Stack, url: "https://en.wikipedia.org/wiki/Stack_(abstract_data_type)", definition: """
    ...
    """)
    private let dataQueue = DataStructureEntity(name: DataType.Queue.rawValue, type: DataType.Queue, url: "https://en.wikipedia.org/wiki/Queue_(abstract_data_type)", definition: """
    ...
    """)
    private let dataSet = DataStructureEntity(name: DataType.Set.rawValue, type: DataType.Set, url: "https://en.wikipedia.org/wiki/Set_(abstract_data_type)", definition: """
    ...
    """)
    private let dataDequeu = DataStructureEntity(name: DataType.Dequeu.rawValue, type: DataType.Dequeu, url: "https://en.wikipedia.org/wiki/Double-ended_queue", definition: """
    ...
    """)
    private let dataPriorityQueue = DataStructureEntity(name: DataType.PriorityQueue.rawValue, type: DataType.PriorityQueue, url: "https://en.wikipedia.org/wiki/Priority_queue", definition: """
    ...
    """)
    private let dataList = DataStructureEntity(name: DataType.List.rawValue, type: DataType.List, url: "https://en.wikipedia.org/wiki/Dynamic_array", definition: """
    ...
    """)
    private let dataMultiSet = DataStructureEntity(name: DataType.MultiSet.rawValue, type: DataType.MultiSet, url: "https://en.wikipedia.org/wiki/Multiset", definition: """
    ...
    """)
    private let dataDictionary = DataStructureEntity(name: DataType.Dictionary.rawValue, type: DataType.Dictionary, url: "https://en.wikipedia.org/wiki/Associative_array", definition: """
