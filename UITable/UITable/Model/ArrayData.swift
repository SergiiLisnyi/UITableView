...
class ArrayData : ArrayDataProtocol {
    ...
    """)
    private let dataQueue = DataStructureEntity(name: "Queue", descr: """
    ...
    """)
    private let dataSet = DataStructureEntity(name: "Set", descr: """
    ...
    """)
    private let dataDequeu = DataStructureEntity(name: "Dequeue", descr: """
    ...
    """)
    private let dataPriorityQueue = DataStructureEntity(name: "Priority Queue", descr: """
    ...
    """)
    private let dataList = DataStructureEntity(name: "List(Array)", descr: """
    ...
    """)
    private let dataMultiSet = DataStructureEntity(name: "MultiSet", descr: """
    ...
    """)
    private let dataDictionary = DataStructureEntity(name: "Dictionary", descr: """
